...
echo dgemm.c
icl -nologo -Qmic -I..\..\include -I"%MKLROOT%\include" -O2 -fPIC -shared -L"%MKLROOT%/lib/mic" -lmkl_intel_lp64 -lmkl_core -lmkl_intel_thread -lpthread -o libdgemm.so dgemm.c
