...
set PYMIC_BASE=C:\Projects\pymic
set PYMIC_LIBRARY_PATH=%PYMIC_BASE%\examples\zgemm;%PYMIC_BASE%\examples\svd;%PYMIC_BASE%\examples\simple;%PYMIC_BASE%\examples\empty_kernel;%PYMIC_BASE%\examples\double_it_lowlevel;%PYMIC_BASE%\examples\double_it;%PYMIC_BASE%\examples\dgemm;%PYMIC_BASE%\examples\data_transfers_offset;%PYMIC_BASE%\examples\data_transfers;%PYMIC_BASE%\examples\data_map;%PYMIC_BASE%\pymic;%PYMIC_BASE%\benchmarks;%PYMIC_BASE%\tests
set PYTHONPATH=%PYMIC_BASE%;%PYTHONPATH%
